...
for k in range(N):
     ...
     arduino.sendData([0,sp[k]]) # Enviar Sp (debe ser una lista)
     
     pv[k] = arduino.rawData[2] # Recibir Pv (Derecha: arduino.rawData[0], Izquierda: arduino.rawData[2])
     cv[k] = arduino.rawData[3] # Recibir Cv (Derecha: arduino.rawData[1], Izquierda: arduino.rawData[3])
